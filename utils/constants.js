...
export const avatarElementForm = document.querySelector('.popup__form-avatar');
...
export const avatarElementClosePopupButton = popupAvatar.querySelector('.popup__close-avatar');
...
export const popupButtonSelectorAvatar = document.querySelector('.popup__button-avatar');

export const submitButtonSelector = document.querySelector('.popup__button_valid');
export const inactiveButtonClass = document.querySelector('.popup__button_invalid');
